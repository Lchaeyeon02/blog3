...
`;function qF(n){const{post:e}=n,{id:t}=xv(),r=lm(),a=()=>{ko.collection("post").doc(t).delete().then(()=>{alert("게시물이 삭제되었습니다."),r("/main")})},o=u=>{let d=u;if(!d)return"날짜 정보 없음";const p=new Date(Number(d)),m=p.getFullYear(),y=String(p.getMonth()+1).padStart(2,"0"),v=String(p.getDate()).padStart(2,"0");return`${m}.${y}.${v}`};return ie.jsxs(MF,{children:[ie.jsxs(zF,{children:[ie.jsxs(BF,{children:[ie.jsxs("a",{href:"",children:[" ",ie.jsx("img",{width:"48px",height:"48px",src:"../public/back.png",alt:"",onClick:()=>{r("/main")}})," "]}),ie.jsx(LF,{children:e.title}),ie.jsx("b",{className:"cateB",children:e.category})]}),ie.jsx(gm,{title:"Delete",type:"upload",onClick:u=>{a()}})]}),ie.jsxs(UF,{children:[e.content,ie.jsx(FF,{children:o(e.timestamp||e.createdAt||e.date)})]})]})}const jF=Pe.div`
    display: grid;
    gap: 20px;
`;function HF(n){const{posts:e,itemClicked:t}=n,r=e.map((a,o)=>ie.jsx(Tk,{post:a,onClick:u=>t(a)},a.id));return ie.jsx(jF,{children:r})}const GF=Pe.div`
    width: auto;
    height: auto;
    color: #2A2C53;
...
`;function ST(n){return ie.jsx(GF,{children:ie.jsxs($F,{children:[ie.jsx(ap,{href:"",children:"message"}),ie.jsx(ap,{href:"",children:"neighbor"}),ie.jsx(ap,{href:"",children:"mypage"}),ie.jsxs(ap,{href:"",children:["welcome, ",ie.jsx("b",{children:"Lee!"})]})]})})}const KF=Pe.p`
    font-size: 54px;
    text-align: center;
...
`,JF=Pe.select`
    ...
    background-size: 110%;
`;function dS(n){const e=lm(),[t,r]=Y.useState([]),a=Y.useRef([]),[o,u]=Y.useState("Newest"),[d,p]=Y.useState("all"),[m,y]=Y.useState(!1),[v,w]=Y.useState(!1);Y.useEffect(()=>{let z=[];ko.collection("post").get().then(W=>{W.forEach(G=>{z.push(G.data())}),z.sort((G,oe)=>oe.id-G.id),a.current=z.slice(),r(z)})},[]);function S(z){u(z.target.value);const W=t.slice();z.target.value==="Newest"?W.sort((G,oe)=>oe.id-G.id):W.sort((G,oe)=>G.id-oe.id),r(W)}function P(z){p(z.target.value);let W;z.target.value==="all"?W=a.current.slice():W=a.current.filter(function(G){return G.category===z.target.value}),r(W)}function U(){y(!m)}function L(){w(!v)}return ie.jsxs(WF,{children:[ie.jsx(ST,{}),ie.jsxs(KF,{children:["Make a note of ",ie.jsx(QF,{children:"your day."})]}),ie.jsx(YF,{children:ie.jsx(gm,{title:"Create a new post",onClick:z=>{e("/write")}})}),ie.jsxs(XF,{children:[ie.jsxs(ZF,{className:"select-btn",value:o,onChange:S,onClick:U,isOpen:m,children:[ie.jsx("option",{value:"Newest",children:"Newest"}),ie.jsx("option",{value:"Oldest",children:"Oldest"})]}),ie.jsxs(JF,{className:"select-btn2",value:d,onChange:P,onClick:L,isOpen:v,children:[ie.jsx("option",{value:"all",children:"all"}),ie.jsx("option",{value:"daily",children:"daily"}),ie.jsx("option",{value:"travel",children:"travel"}),ie.jsx("option",{value:"food",children:"food"}),ie.jsx("option",{value:"hobby",children:"hobby"}),ie.jsx("option",{value:"exercise",children:"book"}),ie.jsx("option",{value:"study",children:"study"})]})]}),ie.jsx(HF,{posts:t,itemClicked:z=>{e(`/post/${z.id}`)}})]})}const e9=Pe.button`
    width: auto;
    height: 51px;
    border-radius: 50px;
    font-size: 24px;
...
`,t9=Pe.div`
    display: flex;
    gap: 20px
`;function n9(n){const e=["daily","travel","food","hobby","book","study"],[t,r]=Y.useState("daily");Y.useEffect(()=>{n.onChange&&n.onChange("daily")},[]);const a=o=>{r(o),n.onChange&&n.onChange(o)};return ie.jsx(t9,{children:e.map((o,u)=>ie.jsx(e9,{selected:t===o,onClick:()=>a(o),children:o},u))})}const r9=Pe.div`
    padding: 50px 80px;
`,xy=Pe.div`
    display: grid;
    gap: 24px;
...
`,s9=Pe.div`
    ...
    margin-top: 117px;
    margin-bottom: 45px;
`;function a9(n){const e=lm(),[t,r]=Y.useState(""),[a,o]=Y.useState(""),[u,d]=Y.useState(""),p=()=>{let y=new Date().getTime().toString();ko.collection("post").doc(y).set({id:y,title:t,content:a,comments:[],date:y,category:u}).then(()=>{alert("글이 등록되었습니다!"),e("/")})},m=y=>{d(y)};return ie.jsxs(r9,{children:[ie.jsx(ST,{}),ie.jsxs(s9,{children:[ie.jsxs("a",{href:"",children:[" ",ie.jsx("img",{width:"48px",height:"48px",src:"../public/back.png",alt:"",onClick:()=>{e("/main")}})," "]}),ie.jsx(gm,{title:"Upload",type:"upload",onClick:y=>{p()}})]}),ie.jsxs(i9,{children:[ie.jsxs(xy,{children:[ie.jsx("label",{className:"labelCss",htmlFor:"",children:"category"}),ie.jsx(n9,{onChange:m})]}),ie.jsxs(xy,{children:[ie.jsx("label",{className:"labelCss",htmlFor:"",children:"title"}),ie.jsx(Fy,{height:"75",value:t,onChange:y=>r(y.target.value)})]}),ie.jsxs(xy,{children:[ie.jsx("label",{className:"labelCss",htmlFor:"",children:"content"}),ie.jsx(Fy,{height:"450",value:a,onChange:y=>o(y.target.value)})]})]})]})}const o9=Pe.div`
    display: grid;
    gap: 16px;
    margin-bottom: 32px;
`,fS=Pe.p`
...
`;Pe.div`
    position : fixed;
    bottom : 0;
`;function c9(n){const{comments:e,onCommentDeleted:t}=n,r=e.map((a,o)=>ie.jsx(VF,{comment:a,onDeleteComment:t},a.id));return ie.jsxs("div",{children:[ie.jsxs(u9,{children:[ie.jsx(fS,{children:"Comment"}),ie.jsxs(l9,{children:[ie.jsx("img",{width:"40px",height:"40px",src:"../public/green-chat.png",alt:""}),ie.jsx(fS,{children:e?e.length:0})]})]}),ie.jsx(o9,{children:r})]})}const h9=Pe.div`
    display: flex;
    gap: 18px
    height: 75px;
`,d9=Pe.div`
    padding: 50px 80px;
`;function f9(n){const e=xv().id,[t,r]=Y.useState({id:e,title:"",content:"",comments:[]});Y.useEffect(()=>{ko.collection("post").doc(e).get().then(p=>{r(p.data())})},[]);const[a,o]=Y.useState(""),u=()=>{let p=new Date().getTime().toString(),m=t.comments;m.push({id:`${e}_${p}`,content:a}),ko.collection("post").doc(e).update({comments:m}).then(()=>{alert("댓글이 등록되었습니다!"),o("")})},d=p=>{r({...t,comments:t.comments.filter(m=>m.id!==p)})};return ie.jsxs(d9,{children:[ie.jsx(ST,{}),ie.jsx(qF,{post:t}),ie.jsx(c9,{comments:t.comments,onCommentDeleted:d}),ie.jsxs(h9,{children:[ie.jsx(Fy,{height:"40",value:a,onChange:p=>{o(p.target.value)}}),ie.jsx(gm,{title:"Upload",type:"chat",onClick:()=>{u()}})]})]})}Fx.createRoot(document.getElementById("root")).render(ie.jsx(eO,{basename:"/blog3",children:ie.jsxs(xN,{children:[ie.jsx(oh,{index:!0,element:ie.jsx(dS,{})}),ie.jsx(oh,{path:"main",element:ie.jsx(dS,{})}),ie.jsx(oh,{path:"write",element:ie.jsx(a9,{})}),ie.jsx(oh,{path:"post/:id",element:ie.jsx(f9,{})})]})}));
