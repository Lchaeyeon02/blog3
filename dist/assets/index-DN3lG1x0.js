...
`,d9=Pe.div`
    padding: 50px 80px;
`;function f9(n){const e=xv().id,[t,r]=Y.useState({id:e,title:"",content:"",comments:[]});Y.useEffect(()=>{ko.collection("post").doc(e).get().then(p=>{r(p.data())})},[]);const[a,o]=Y.useState(""),u=()=>{let p=new Date().getTime().toString(),m=t.comments;m.push({id:`${e}_${p}`,content:a}),ko.collection("post").doc(e).update({comments:m}).then(()=>{alert("댓글이 등록되었습니다!"),o("")})},d=p=>{r({...t,comments:t.comments.filter(m=>m.id!==p)})};return ie.jsxs(d9,{children:[ie.jsx(ST,{}),ie.jsx(qF,{post:t}),ie.jsx(c9,{comments:t.comments,onCommentDeleted:d}),ie.jsxs(h9,{children:[ie.jsx(Fy,{height:"40",value:a,onChange:p=>{o(p.target.value)}}),ie.jsx(gm,{title:"Upload",type:"chat",onClick:()=>{u()}})]})]})}Fx.createRoot(document.getElementById("root")).render(ie.jsx(eO,{basename:"/",children:ie.jsxs(xN,{children:[ie.jsx(oh,{index:!0,element:ie.jsx(dS,{})}),ie.jsx(oh,{path:"main",element:ie.jsx(dS,{})}),ie.jsx(oh,{path:"write",element:ie.jsx(a9,{})}),ie.jsx(oh,{path:"post/:id",element:ie.jsx(f9,{})})]})}));
